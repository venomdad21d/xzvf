...
@mody.tgbot.on(CallbackQuery(data=re.compile(r"^age_verification_true")))
...
@mody.tgbot.on(CallbackQuery(data=re.compile(r"^age_verification_false")))
...
@mody.tgbot.on(CallbackQuery(data=re.compile(r"^chg_of_decision_")))
