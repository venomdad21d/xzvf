import sys
import SourceVenom
from SourceVenom import BOTLOG_CHATID, HEROKU_APP, PM_LOGGER_GROUP_ID
...
print(SourceVenom.__copyright__)
print("Licensed under the terms of the " + SourceZe.__license__)

cmdhr = Config.COMMAND_HAND_LER

try:
    LOGS.info("جارِ بدء بوت فينوم ✓")
